# Native WebArena evaluator provenance
...
- collision planning lives in `nemo_gym.web.native_eval_collision`, where
...
The native lifecycle preserves both snapshot sources used by the pinned
...
Public benchmark credentials are resolved through the native site's
